    ...
    <div class="col-md-12 grid-margin">
      <div class="d-flex justify-content-between flex-wrap">
        ...
        <div class="d-flex align-items-end flex-wrap">
            ...
            <p class="text-primary mb-0 hover-cursor">Marque&nbsp;/&nbsp;Ajouter</p>
            </div>
        </div>
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('admin.brand.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="d-flex">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" aria-label="Default select example" id="category_id" name="category_id">
                            <option selected value="NULL">Choisir la categorie</option>  
